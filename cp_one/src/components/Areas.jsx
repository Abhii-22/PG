...
const areasData = [
  ...
  },
  {
    ...
    pgs: [
      { id: 3, name: 'Star PG', images: ['https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&w=400&h=300'], price: 8000, sharing: 'Triple', rating: 4.0, gender: 'Boys', location: 'HSR Layout Sector 2', description: 'Affordable and well-maintained PG with all essential facilities.', facilities: ['Wifi'] },
    ],
  },
  {
    name: 'Marathahalli',
    ...
    pgs: [
      { id: 4, name: 'Comfort Stay PG', images: ['https://images.unsplash.com/photo-1522771739844-6a9f6d5f14af?auto=format&fit=crop&w=400&h=300'], price: 12000, sharing: 'Twin', rating: 4.8, gender: 'Unisex', location: 'Near Marathahalli Bridge', description: 'Premium accommodation with a focus on quality and service.', facilities: ['Wifi', 'TV', 'Refrigerator', 'Washing Machine'] },
      { id: 5, name: 'Happy Homes PG', images: ['https://images.unsplash.com/photo-1540518614846-7eded433c457?auto=format&fit=crop&w=400&h=300'], price: 7500, sharing: 'Four', rating: 3.9, gender: 'Boys', location: 'Outer Ring Road', description: 'Budget-friendly PG for those looking for a comfortable stay without breaking the bank.', facilities: ['Wifi'] },
    ],
  },
  {
    name: 'Vijayanagar',
    ...
    pgs: [
      { id: 6, name: 'Royal PG', images: ['https://images.unsplash.com/photo-1595526114035-0d45ed16cfbf?auto=format&fit=crop&w=400&h=300'], price: 10000, sharing: 'Twin', rating: 4.3, gender: 'Girls', location: 'Near Vijayanagar Metro', description: 'Modern living space with excellent connectivity and amenities.', facilities: ['Wifi', 'TV'] },
    ],
  },
];
            ...
            <div key={pg.id} className="pg-detailed-card">
              ...
              <div className="pg-detailed-info">
                ...
                <div className="pg-detailed-footer">
                  <a href="#contact-us" className="btn btn-danger">Contact</a>
